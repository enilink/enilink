 ...
 */
public class BasicModelEditorBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 */
	protected IAction refreshViewerAction = new Action(EnilinkWorkbenchPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 */
	protected IAction showPropertiesViewAction = new Action(EnilinkWorkbenchPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	public void selectionChanged(SelectionChangedEvent event) {
		final IEditingDomain domain = ((IEditingDomainProvider) activeEditorPart).getEditingDomain();
