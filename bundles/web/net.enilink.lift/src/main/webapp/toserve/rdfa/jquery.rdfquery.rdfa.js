...
(function ($) {
          ...
          if (hasAttributeNS(p, rdfNs, 'resource')) {
            ...
            if (parseType === 'Literal') {
              try {
                ...
                var tag = serializer.serializeToString(p);
                o = tag.substring(tag.indexOf('>')+1, tag.lastIndexOf('<'))
              } catch (e) {
                o = "";
  ...
  $.rdf.dump = function (triples, options) {
    ...
    if (format === 'application/json') {
      ...
      return serialize ? JSON.stringify(dump) : dump;
  ...
  $.fn.rdf = function (callback) {
    var triples = [];
    var cb = callback ? callback : function(node, triple) {
    	triples.push(triple)
    }
...
(function ($) {
  ...
  var
    ...
    getAttributes = function (elem) {
      ...
      ns[':length'] = 0;
        ...
        for (i = 0; i < attMap.length; i += 1) {
          ...
          if (/^rel$|^rev$|^lang$|^xml:lang$/.test(a.nodeName) && a.nodeValue) {
      ...
      if (!e.attributes.getNamedItemNS) {
        tag = /<[^>]+>/.exec(e.outerHTML);
        a = attRegex.exec(tag);
        while (a !== null) {
          name = a[1];
    ...
    resourceFromSafeCurie = function (safeCurie, elem, options) {
      ...
      return resourceFromCurie(m ? m[1] : safeCurie, elem, options);
    },
    ...
    getLang = function (elem, context) {
      ...
      if (context.atts) {
        ...
        try { lang = (lang === null || lang === '') ? elem[0].getAttribute('xml:lang') : lang; } catch(e) {/*IE*/}
    ...
    rdfa = function (context) {
      ...
      if (subject.skip) {
        ...
        if (forward.length > 0 || backward.length > 0) {
          ...
          for (i = 0; i < forward.length; i += 1) {
            ...
            callback.call(this.get(0), this.get(0), triple);
          }
      ...
      children.each(function () {
        rdfa.call($(this), { forward: rels, backward: revs, subject: subject, object: resource || subject, lang: lang, namespaces: namespaces, callback: callback });
      });
    },
