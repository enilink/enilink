...
object CurrentContext extends DynamicVariable[Box[RdfContext]](Empty) {
  ...
  lazy val selectionProviders = Platform.getExtensionRegistry.getExtensionPoint("net.enilink.platform.lift.selectionProviders").getConfigurationElements.flatMap {
