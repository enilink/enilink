...
public class UpdateList implements Operation{
    ...
    public AbstractGraphNode subject(){ return this.subject; }
    ...
    public AbstractGraphNode predicate(){ return this.predicate; }
    ...
    public Collection collection(){ return  this.collection; }
    ...
    public Slice slice(){ return this.slice; }
}
